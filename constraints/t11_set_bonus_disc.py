...
if len(t11_4p) >= 4:
    ...
    t11_4p_spirit = pulp.LpVariable(N('t11_4p_spirit'), 0, cat = 'Integer')

    problem += pulp.lpSum([ 0.25 * self.used[item] for item in t11_4p ]) >= t11_4p_used

    # Disc only had about 50% uptime of the t11 4-piece set bonus.
    problem += t11_4p_spirit == self.total_stats[I['spirit']] + 0.5 * 540 * t11_4p_used
